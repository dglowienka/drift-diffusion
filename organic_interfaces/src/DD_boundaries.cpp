...
void Drift_diffusion::set_boundaries_space(void)
{
	...
	tmp_boundaries.concentration_s_bottom_scaled = 0;
	...
	tmp_boundaries.concentration_s_top_scaled = 0;
...
void Drift_diffusion::set_boundaries_time(void)
{
	...
	result_it_scaled.s_scaled.resize(grid_scaled.N_points_scaled);
